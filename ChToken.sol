...
contract ChToken is MintableToken {
    // Define 3 public state variables: name, symbol, number of decimals.
    string public constant name = "ChToken"; // solium-disable-line uppercase
    string public constant symbol = "CHET"; // solium-disable-line uppercase
